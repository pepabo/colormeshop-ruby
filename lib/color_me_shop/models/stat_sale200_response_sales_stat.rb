...
module ColorMeShop
  class StatSale200ResponseSalesStat
    # ショップアカウントID
    ...
    # 合計売上金額
    attr_accessor :amount_today

    # 合計件数
    attr_accessor :count_today

    # `date`を含む過去7日間の合計売上金額
    attr_accessor :amount_last_7days

    # `date`を含む過去7日間の合計件数
    attr_accessor :count_last_7days

    # `date`が含まれる月の合計売上金額
    attr_accessor :amount_this_month

    # `date`が含まれる月の合計件数
    attr_accessor :count_this_month
    ...
    def self.openapi_types
      {
        :'account_id' => :'String',
        :'date' => :'Integer',
        :'amount_today' => :'Integer',
        :'count_today' => :'Integer',
        :'amount_last_7days' => :'Integer',
        :'count_last_7days' => :'Integer',
        :'amount_this_month' => :'Integer',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ColorMeShop::StatSale200ResponseSalesStat` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ColorMeShop::StatSale200ResponseSalesStat`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'amount_today')
        self.amount_today = attributes[:'amount_today']
      end

      if attributes.key?(:'count_today')
        self.count_today = attributes[:'count_today']
      end

      if attributes.key?(:'amount_last_7days')
        self.amount_last_7days = attributes[:'amount_last_7days']
      end

      if attributes.key?(:'count_last_7days')
        self.count_last_7days = attributes[:'count_last_7days']
      end

      if attributes.key?(:'amount_this_month')
        self.amount_this_month = attributes[:'amount_this_month']
      end

      if attributes.key?(:'count_this_month')
        self.count_this_month = attributes[:'count_this_month']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          date == o.date &&
          amount_today == o.amount_today &&
          count_today == o.count_today &&
          amount_last_7days == o.amount_last_7days &&
          count_last_7days == o.count_last_7days &&
          amount_this_month == o.amount_this_month &&
          count_this_month == o.count_this_month
    end
    ...
    def hash
      [account_id, date, amount_today, count_today, amount_last_7days, count_last_7days, amount_this_month, count_this_month].hash
    end
