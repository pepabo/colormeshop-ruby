...
# Unit tests for ColorMeShop::GetProducts200ResponseProductsInnerCategory
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::GetProducts200ResponseProductsInnerCategory do
  let(:instance) { ColorMeShop::GetProducts200ResponseProductsInnerCategory.new }

  describe 'test an instance of GetProducts200ResponseProductsInnerCategory' do
    it 'should create an instance of GetProducts200ResponseProductsInnerCategory' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::GetProducts200ResponseProductsInnerCategory)
    end
  end
