...
# Unit tests for ColorMeShop::GetSales200ResponseSalesInnerSegment
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::GetSales200ResponseSalesInnerSegment do
  let(:instance) { ColorMeShop::GetSales200ResponseSalesInnerSegment.new }

  describe 'test an instance of GetSales200ResponseSalesInnerSegment' do
    it 'should create an instance of GetSales200ResponseSalesInnerSegment' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::GetSales200ResponseSalesInnerSegment)
    end
  end
  ...
  describe 'test attribute "parent_sale_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "splitted"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
