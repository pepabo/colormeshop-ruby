...
# Unit tests for ColorMeShop::GetSale200ResponseSale
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::GetSale200ResponseSale do
  let(:instance) { ColorMeShop::GetSale200ResponseSale.new }

  describe 'test an instance of GetSale200ResponseSale' do
    it 'should create an instance of GetSale200ResponseSale' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::GetSale200ResponseSale)
    end
  end
