...
# Unit tests for ColorMeShop::StatSale200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::StatSale200Response do
  let(:instance) { ColorMeShop::StatSale200Response.new }

  describe 'test an instance of StatSale200Response' do
    it 'should create an instance of StatSale200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::StatSale200Response)
    end
  end

  describe 'test attribute "sales_stat"' do
    it 'should work' do
