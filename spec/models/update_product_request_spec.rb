...
# Unit tests for ColorMeShop::UpdateProductRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::UpdateProductRequest do
  let(:instance) { ColorMeShop::UpdateProductRequest.new }

  describe 'test an instance of UpdateProductRequest' do
    it 'should create an instance of UpdateProductRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::UpdateProductRequest)
    end
  end
