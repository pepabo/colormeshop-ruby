...
# Unit tests for ColorMeShop::DeliveryChargeByPrefecture
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::DeliveryChargeByPrefecture do
  let(:instance) { ColorMeShop::DeliveryChargeByPrefecture.new }

  describe 'test an instance of DeliveryChargeByPrefecture' do
    it 'should create an instance of DeliveryChargeByPrefecture' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::DeliveryChargeByPrefecture)
    end
  end
