...
# Unit tests for ColorMeShop::ProductCreateRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::ProductCreateRequest do
  let(:instance) { ColorMeShop::ProductCreateRequest.new }

  describe 'test an instance of ProductCreateRequest' do
    it 'should create an instance of ProductCreateRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::ProductCreateRequest)
    end
  end
