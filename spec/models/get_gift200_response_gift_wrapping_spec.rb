...
# Unit tests for ColorMeShop::GetGift200ResponseGiftWrapping
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::GetGift200ResponseGiftWrapping do
  let(:instance) { ColorMeShop::GetGift200ResponseGiftWrapping.new }

  describe 'test an instance of GetGift200ResponseGiftWrapping' do
    it 'should create an instance of GetGift200ResponseGiftWrapping' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::GetGift200ResponseGiftWrapping)
    end
  end
