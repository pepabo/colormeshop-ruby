...
# Unit tests for ColorMeShop::GetSale200ResponseSaleAllOfSegment
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::GetSale200ResponseSaleAllOfSegment do
  let(:instance) { ColorMeShop::GetSale200ResponseSaleAllOfSegment.new }

  describe 'test an instance of GetSale200ResponseSaleAllOfSegment' do
    it 'should create an instance of GetSale200ResponseSaleAllOfSegment' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::GetSale200ResponseSaleAllOfSegment)
    end
  end

  describe 'test attribute "siblings_sale_ids"' do
    it 'should work' do
