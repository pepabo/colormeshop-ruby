...
# Unit tests for ColorMeShop::UpdateProductRequestProduct
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::UpdateProductRequestProduct do
  let(:instance) { ColorMeShop::UpdateProductRequestProduct.new }

  describe 'test an instance of UpdateProductRequestProduct' do
    it 'should create an instance of UpdateProductRequestProduct' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::UpdateProductRequestProduct)
    end
  end
  ...
  describe 'test attribute "category_id_big"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "category_id_small"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
