...
# Unit tests for ColorMeShop::GetProductCategories200ResponseCategoriesInnerChildrenInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::GetProductCategories200ResponseCategoriesInnerChildrenInner do
  let(:instance) { ColorMeShop::GetProductCategories200ResponseCategoriesInnerChildrenInner.new }

  describe 'test an instance of GetProductCategories200ResponseCategoriesInnerChildrenInner' do
    it 'should create an instance of GetProductCategories200ResponseCategoriesInnerChildrenInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::GetProductCategories200ResponseCategoriesInnerChildrenInner)
    end
  end

  describe 'test attribute "id_big"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "id_small"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "display_state"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["showing", "hidden", "members_only"])
