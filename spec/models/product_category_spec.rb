...
# Unit tests for ColorMeShop::ProductCategory
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::ProductCategory do
  let(:instance) { ColorMeShop::ProductCategory.new }

  describe 'test an instance of ProductCategory' do
    it 'should create an instance of ProductCategory' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::ProductCategory)
    end
  end
