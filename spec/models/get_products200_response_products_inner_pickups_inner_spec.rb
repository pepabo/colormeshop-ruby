...
# Unit tests for ColorMeShop::GetProducts200ResponseProductsInnerPickupsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::GetProducts200ResponseProductsInnerPickupsInner do
  let(:instance) { ColorMeShop::GetProducts200ResponseProductsInnerPickupsInner.new }

  describe 'test an instance of GetProducts200ResponseProductsInnerPickupsInner' do
    it 'should create an instance of GetProducts200ResponseProductsInnerPickupsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::GetProducts200ResponseProductsInnerPickupsInner)
    end
  end
