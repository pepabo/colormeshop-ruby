...
# Unit tests for ColorMeShop::GetDeliveries200ResponseDeliveriesInnerCharge
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::GetDeliveries200ResponseDeliveriesInnerCharge do
  let(:instance) { ColorMeShop::GetDeliveries200ResponseDeliveriesInnerCharge.new }

  describe 'test an instance of GetDeliveries200ResponseDeliveriesInnerCharge' do
    it 'should create an instance of GetDeliveries200ResponseDeliveriesInnerCharge' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::GetDeliveries200ResponseDeliveriesInnerCharge)
    end
  end
  ...
  describe 'test attribute "charge_fixed"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "charge_ranges_by_price"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "charge_max_price"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "charge_ranges_by_area"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "charge_ranges_by_weight"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "charge_ranges_max_weight"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
