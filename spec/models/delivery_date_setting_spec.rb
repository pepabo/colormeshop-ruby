...
# Unit tests for ColorMeShop::DeliveryDateSetting
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::DeliveryDateSetting do
  let(:instance) { ColorMeShop::DeliveryDateSetting.new }

  describe 'test an instance of DeliveryDateSetting' do
    it 'should create an instance of DeliveryDateSetting' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::DeliveryDateSetting)
    end
  end
