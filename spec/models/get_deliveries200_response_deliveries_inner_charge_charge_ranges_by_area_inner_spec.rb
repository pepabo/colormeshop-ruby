...
# Unit tests for ColorMeShop::GetDeliveries200ResponseDeliveriesInnerChargeChargeRangesByAreaInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::GetDeliveries200ResponseDeliveriesInnerChargeChargeRangesByAreaInner do
  let(:instance) { ColorMeShop::GetDeliveries200ResponseDeliveriesInnerChargeChargeRangesByAreaInner.new }

  describe 'test an instance of GetDeliveries200ResponseDeliveriesInnerChargeChargeRangesByAreaInner' do
    it 'should create an instance of GetDeliveries200ResponseDeliveriesInnerChargeChargeRangesByAreaInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::GetDeliveries200ResponseDeliveriesInnerChargeChargeRangesByAreaInner)
    end
  end
