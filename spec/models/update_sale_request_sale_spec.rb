...
# Unit tests for ColorMeShop::UpdateSaleRequestSale
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::UpdateSaleRequestSale do
  let(:instance) { ColorMeShop::UpdateSaleRequestSale.new }

  describe 'test an instance of UpdateSaleRequestSale' do
    it 'should create an instance of UpdateSaleRequestSale' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::UpdateSaleRequestSale)
    end
  end
