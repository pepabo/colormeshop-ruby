...
# Unit tests for ColorMeShop::GetGift200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::GetGift200Response do
  let(:instance) { ColorMeShop::GetGift200Response.new }

  describe 'test an instance of GetGift200Response' do
    it 'should create an instance of GetGift200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::GetGift200Response)
    end
  end
