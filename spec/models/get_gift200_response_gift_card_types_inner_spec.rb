...
# Unit tests for ColorMeShop::GetGift200ResponseGiftCardTypesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::GetGift200ResponseGiftCardTypesInner do
  let(:instance) { ColorMeShop::GetGift200ResponseGiftCardTypesInner.new }

  describe 'test an instance of GetGift200ResponseGiftCardTypesInner' do
    it 'should create an instance of GetGift200ResponseGiftCardTypesInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::GetGift200ResponseGiftCardTypesInner)
    end
  end
