...
# Unit tests for ColorMeShop::SendSalesMailRequestMail
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::SendSalesMailRequestMail do
  let(:instance) { ColorMeShop::SendSalesMailRequestMail.new }

  describe 'test an instance of SendSalesMailRequestMail' do
    it 'should create an instance of SendSalesMailRequestMail' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::SendSalesMailRequestMail)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["accepted", "paid", "delivered"])
