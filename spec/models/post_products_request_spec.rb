...
# Unit tests for ColorMeShop::PostProductsRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::PostProductsRequest do
  let(:instance) { ColorMeShop::PostProductsRequest.new }

  describe 'test an instance of PostProductsRequest' do
    it 'should create an instance of PostProductsRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::PostProductsRequest)
    end
  end
