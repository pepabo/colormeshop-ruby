...
# Unit tests for ColorMeShop::PutProductPickupRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::PutProductPickupRequest do
  let(:instance) { ColorMeShop::PutProductPickupRequest.new }

  describe 'test an instance of PutProductPickupRequest' do
    it 'should create an instance of PutProductPickupRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::PutProductPickupRequest)
    end
  end
  ...
  describe 'test attribute "pickup_type"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('Integer', [0, 1, 3, 4])
