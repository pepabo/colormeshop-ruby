...
# Unit tests for ColorMeShop::GetCoupons200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::GetCoupons200Response do
  let(:instance) { ColorMeShop::GetCoupons200Response.new }

  describe 'test an instance of GetCoupons200Response' do
    it 'should create an instance of GetCoupons200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::GetCoupons200Response)
    end
  end

  describe 'test attribute "shop_coupons"' do
    it 'should work' do
