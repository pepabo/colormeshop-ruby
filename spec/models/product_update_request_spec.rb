...
# Unit tests for ColorMeShop::ProductUpdateRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::ProductUpdateRequest do
  let(:instance) { ColorMeShop::ProductUpdateRequest.new }

  describe 'test an instance of ProductUpdateRequest' do
    it 'should create an instance of ProductUpdateRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::ProductUpdateRequest)
    end
  end
