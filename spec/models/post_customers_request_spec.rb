...
# Unit tests for ColorMeShop::PostCustomersRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::PostCustomersRequest do
  let(:instance) { ColorMeShop::PostCustomersRequest.new }

  describe 'test an instance of PostCustomersRequest' do
    it 'should create an instance of PostCustomersRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::PostCustomersRequest)
    end
  end
