...
# Unit tests for ColorMeShop::GetProducts200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::GetProducts200Response do
  let(:instance) { ColorMeShop::GetProducts200Response.new }

  describe 'test an instance of GetProducts200Response' do
    it 'should create an instance of GetProducts200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::GetProducts200Response)
    end
  end
