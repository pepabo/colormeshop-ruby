...
# Unit tests for ColorMeShop::GetSales200ResponseMeta
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::GetSales200ResponseMeta do
  let(:instance) { ColorMeShop::GetSales200ResponseMeta.new }

  describe 'test an instance of GetSales200ResponseMeta' do
    it 'should create an instance of GetSales200ResponseMeta' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::GetSales200ResponseMeta)
    end
  end
