...
# Unit tests for ColorMeShop::UpdateProductRequestProductVariantsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::UpdateProductRequestProductVariantsInner do
  let(:instance) { ColorMeShop::UpdateProductRequestProductVariantsInner.new }

  describe 'test an instance of UpdateProductRequestProductVariantsInner' do
    it 'should create an instance of UpdateProductRequestProductVariantsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::UpdateProductRequestProductVariantsInner)
    end
  end
