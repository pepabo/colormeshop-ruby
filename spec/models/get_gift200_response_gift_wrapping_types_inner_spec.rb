...
# Unit tests for ColorMeShop::GetGift200ResponseGiftWrappingTypesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::GetGift200ResponseGiftWrappingTypesInner do
  let(:instance) { ColorMeShop::GetGift200ResponseGiftWrappingTypesInner.new }

  describe 'test an instance of GetGift200ResponseGiftWrappingTypesInner' do
    it 'should create an instance of GetGift200ResponseGiftWrappingTypesInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::GetGift200ResponseGiftWrappingTypesInner)
    end
  end
