...
# Unit tests for ColorMeShop::PostCustomersRequestCustomer
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::PostCustomersRequestCustomer do
  let(:instance) { ColorMeShop::PostCustomersRequestCustomer.new }

  describe 'test an instance of PostCustomersRequestCustomer' do
    it 'should create an instance of PostCustomersRequestCustomer' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::PostCustomersRequestCustomer)
    end
  end
  ...
  describe 'test attribute "add_member"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
