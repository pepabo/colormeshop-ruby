...
# Unit tests for ColorMeShop::GetPayments200ResponsePaymentsInnerCard
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::GetPayments200ResponsePaymentsInnerCard do
  let(:instance) { ColorMeShop::GetPayments200ResponsePaymentsInnerCard.new }

  describe 'test an instance of GetPayments200ResponsePaymentsInnerCard' do
    it 'should create an instance of GetPayments200ResponsePaymentsInnerCard' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::GetPayments200ResponsePaymentsInnerCard)
    end
  end
