...
# Unit tests for ColorMeShop::SendSalesMailRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::SendSalesMailRequest do
  let(:instance) { ColorMeShop::SendSalesMailRequest.new }

  describe 'test an instance of SendSalesMailRequest' do
    it 'should create an instance of SendSalesMailRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::SendSalesMailRequest)
    end
  end
