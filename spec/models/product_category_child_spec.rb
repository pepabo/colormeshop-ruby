...
# Unit tests for ColorMeShop::ProductCategoryChild
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::ProductCategoryChild do
  let(:instance) { ColorMeShop::ProductCategoryChild.new }

  describe 'test an instance of ProductCategoryChild' do
    it 'should create an instance of ProductCategoryChild' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::ProductCategoryChild)
    end
  end
