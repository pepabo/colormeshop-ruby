...
# Unit tests for ColorMeShop::GetDeliveryDateSetting200ResponseDeliveryDateDays
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::GetDeliveryDateSetting200ResponseDeliveryDateDays do
  let(:instance) { ColorMeShop::GetDeliveryDateSetting200ResponseDeliveryDateDays.new }

  describe 'test an instance of GetDeliveryDateSetting200ResponseDeliveryDateDays' do
    it 'should create an instance of GetDeliveryDateSetting200ResponseDeliveryDateDays' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::GetDeliveryDateSetting200ResponseDeliveryDateDays)
    end
  end
