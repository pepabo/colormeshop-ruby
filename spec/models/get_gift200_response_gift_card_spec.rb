...
# Unit tests for ColorMeShop::GetGift200ResponseGiftCard
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::GetGift200ResponseGiftCard do
  let(:instance) { ColorMeShop::GetGift200ResponseGiftCard.new }

  describe 'test an instance of GetGift200ResponseGiftCard' do
    it 'should create an instance of GetGift200ResponseGiftCard' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::GetGift200ResponseGiftCard)
    end
  end
