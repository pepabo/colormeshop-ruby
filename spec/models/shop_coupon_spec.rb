...
# Unit tests for ColorMeShop::ShopCoupon
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::ShopCoupon do
  let(:instance) { ColorMeShop::ShopCoupon.new }

  describe 'test an instance of ShopCoupon' do
    it 'should create an instance of ShopCoupon' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::ShopCoupon)
    end
  end
