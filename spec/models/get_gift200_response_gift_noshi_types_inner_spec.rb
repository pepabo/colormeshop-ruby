...
# Unit tests for ColorMeShop::GetGift200ResponseGiftNoshiTypesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::GetGift200ResponseGiftNoshiTypesInner do
  let(:instance) { ColorMeShop::GetGift200ResponseGiftNoshiTypesInner.new }

  describe 'test an instance of GetGift200ResponseGiftNoshiTypesInner' do
    it 'should create an instance of GetGift200ResponseGiftNoshiTypesInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::GetGift200ResponseGiftNoshiTypesInner)
    end
  end
