...
# Unit tests for ColorMeShop::ProductOption
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::ProductOption do
  let(:instance) { ColorMeShop::ProductOption.new }

  describe 'test an instance of ProductOption' do
    it 'should create an instance of ProductOption' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::ProductOption)
    end
  end
