...
# Unit tests for ColorMeShop::GetProducts200ResponseProductsInnerImagesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::GetProducts200ResponseProductsInnerImagesInner do
  let(:instance) { ColorMeShop::GetProducts200ResponseProductsInnerImagesInner.new }

  describe 'test an instance of GetProducts200ResponseProductsInnerImagesInner' do
    it 'should create an instance of GetProducts200ResponseProductsInnerImagesInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::GetProducts200ResponseProductsInnerImagesInner)
    end
  end
