...
# Unit tests for ColorMeShop::GetProducts200ResponseProductsInnerOptionsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::GetProducts200ResponseProductsInnerOptionsInner do
  let(:instance) { ColorMeShop::GetProducts200ResponseProductsInnerOptionsInner.new }

  describe 'test an instance of GetProducts200ResponseProductsInnerOptionsInner' do
    it 'should create an instance of GetProducts200ResponseProductsInnerOptionsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::GetProducts200ResponseProductsInnerOptionsInner)
    end
  end
