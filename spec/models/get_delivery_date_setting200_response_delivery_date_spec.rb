...
# Unit tests for ColorMeShop::GetDeliveryDateSetting200ResponseDeliveryDate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::GetDeliveryDateSetting200ResponseDeliveryDate do
  let(:instance) { ColorMeShop::GetDeliveryDateSetting200ResponseDeliveryDate.new }

  describe 'test an instance of GetDeliveryDateSetting200ResponseDeliveryDate' do
    it 'should create an instance of GetDeliveryDateSetting200ResponseDeliveryDate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::GetDeliveryDateSetting200ResponseDeliveryDate)
    end
  end
