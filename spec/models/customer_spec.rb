...
# Unit tests for ColorMeShop::Customer
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::Customer do
  let(:instance) { ColorMeShop::Customer.new }

  describe 'test an instance of Customer' do
    it 'should create an instance of Customer' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::Customer)
    end
  end
