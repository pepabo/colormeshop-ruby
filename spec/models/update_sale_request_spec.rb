...
# Unit tests for ColorMeShop::UpdateSaleRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::UpdateSaleRequest do
  let(:instance) { ColorMeShop::UpdateSaleRequest.new }

  describe 'test an instance of UpdateSaleRequest' do
    it 'should create an instance of UpdateSaleRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::UpdateSaleRequest)
    end
  end
