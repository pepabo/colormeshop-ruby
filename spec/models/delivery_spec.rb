...
# Unit tests for ColorMeShop::Delivery
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::Delivery do
  let(:instance) { ColorMeShop::Delivery.new }

  describe 'test an instance of Delivery' do
    it 'should create an instance of Delivery' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::Delivery)
    end
  end
