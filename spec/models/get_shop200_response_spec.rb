...
# Unit tests for ColorMeShop::GetShop200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::GetShop200Response do
  let(:instance) { ColorMeShop::GetShop200Response.new }

  describe 'test an instance of GetShop200Response' do
    it 'should create an instance of GetShop200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::GetShop200Response)
    end
  end
