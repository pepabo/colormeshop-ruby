...
# Unit tests for ColorMeShop::GetPayments200ResponsePaymentsInnerCod
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::GetPayments200ResponsePaymentsInnerCod do
  let(:instance) { ColorMeShop::GetPayments200ResponsePaymentsInnerCod.new }

  describe 'test an instance of GetPayments200ResponsePaymentsInnerCod' do
    it 'should create an instance of GetPayments200ResponsePaymentsInnerCod' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::GetPayments200ResponsePaymentsInnerCod)
    end
  end

  describe 'test attribute "changeable"' do
    it 'should work' do
  ...
  describe 'test attribute "fee_max"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "changeable_by_total"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
