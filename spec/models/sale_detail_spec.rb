...
# Unit tests for ColorMeShop::SaleDetail
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::SaleDetail do
  let(:instance) { ColorMeShop::SaleDetail.new }

  describe 'test an instance of SaleDetail' do
    it 'should create an instance of SaleDetail' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::SaleDetail)
    end
  end
