...
# Unit tests for ColorMeShop::GetPayments200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::GetPayments200Response do
  let(:instance) { ColorMeShop::GetPayments200Response.new }

  describe 'test an instance of GetPayments200Response' do
    it 'should create an instance of GetPayments200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::GetPayments200Response)
    end
  end
