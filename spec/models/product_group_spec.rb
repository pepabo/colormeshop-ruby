...
# Unit tests for ColorMeShop::ProductGroup
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::ProductGroup do
  let(:instance) { ColorMeShop::ProductGroup.new }

  describe 'test an instance of ProductGroup' do
    it 'should create an instance of ProductGroup' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::ProductGroup)
    end
  end
