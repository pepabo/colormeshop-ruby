...
# Unit tests for ColorMeShop::ProductVariant
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::ProductVariant do
  let(:instance) { ColorMeShop::ProductVariant.new }

  describe 'test an instance of ProductVariant' do
    it 'should create an instance of ProductVariant' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::ProductVariant)
    end
  end
