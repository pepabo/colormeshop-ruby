...
# Unit tests for ColorMeShop::GetProductCategories200ResponseCategoriesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::GetProductCategories200ResponseCategoriesInner do
  let(:instance) { ColorMeShop::GetProductCategories200ResponseCategoriesInner.new }

  describe 'test an instance of GetProductCategories200ResponseCategoriesInner' do
    it 'should create an instance of GetProductCategories200ResponseCategoriesInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::GetProductCategories200ResponseCategoriesInner)
    end
  end
