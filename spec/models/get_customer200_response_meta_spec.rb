...
# Unit tests for ColorMeShop::GetCustomer200ResponseMeta
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::GetCustomer200ResponseMeta do
  let(:instance) { ColorMeShop::GetCustomer200ResponseMeta.new }

  describe 'test an instance of GetCustomer200ResponseMeta' do
    it 'should create an instance of GetCustomer200ResponseMeta' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::GetCustomer200ResponseMeta)
    end
  end
