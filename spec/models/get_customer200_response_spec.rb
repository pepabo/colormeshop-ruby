...
# Unit tests for ColorMeShop::GetCustomer200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::GetCustomer200Response do
  let(:instance) { ColorMeShop::GetCustomer200Response.new }

  describe 'test an instance of GetCustomer200Response' do
    it 'should create an instance of GetCustomer200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::GetCustomer200Response)
    end
  end
