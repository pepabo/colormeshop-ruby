...
# Unit tests for ColorMeShop::GetSales200ResponseSalesInnerCustomer
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::GetSales200ResponseSalesInnerCustomer do
  let(:instance) { ColorMeShop::GetSales200ResponseSalesInnerCustomer.new }

  describe 'test an instance of GetSales200ResponseSalesInnerCustomer' do
    it 'should create an instance of GetSales200ResponseSalesInnerCustomer' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::GetSales200ResponseSalesInnerCustomer)
    end
  end
  ...
  describe 'test attribute "busho"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "tel_mobile"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "receive_mail_magazine"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "answer_free_form1"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "answer_free_form2"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "answer_free_form3"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
