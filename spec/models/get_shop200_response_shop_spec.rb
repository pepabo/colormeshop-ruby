...
# Unit tests for ColorMeShop::GetShop200ResponseShop
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::GetShop200ResponseShop do
  let(:instance) { ColorMeShop::GetShop200ResponseShop.new }

  describe 'test an instance of GetShop200ResponseShop' do
    it 'should create an instance of GetShop200ResponseShop' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::GetShop200ResponseShop)
    end
  end
  ...
  describe 'test attribute "contract_plan"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["unknown", "economy", "small", "regular", "lolipop", "heteml", "platinum", "goope", "large", "dormant", "free", "premium"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "open_state"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["opened", "closed", "prepare", "paused"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "tax_type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["excluded", "included"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "tax_rounding_method"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["round_off", "round_down", "round_up"])
      # validator.allowable_values.each do |value|
      #   expect { instance.tax_rounding_method = value }.not_to raise_error
      # end
    end
  end
  ...
  describe 'test attribute "shop_logo_url"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
