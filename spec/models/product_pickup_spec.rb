...
# Unit tests for ColorMeShop::ProductPickup
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::ProductPickup do
  let(:instance) { ColorMeShop::ProductPickup.new }

  describe 'test an instance of ProductPickup' do
    it 'should create an instance of ProductPickup' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::ProductPickup)
    end
  end
