...
# Unit tests for ColorMeShop::GetPayments200ResponsePaymentsInnerFinancial
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::GetPayments200ResponsePaymentsInnerFinancial do
  let(:instance) { ColorMeShop::GetPayments200ResponsePaymentsInnerFinancial.new }

  describe 'test an instance of GetPayments200ResponsePaymentsInnerFinancial' do
    it 'should create an instance of GetPayments200ResponsePaymentsInnerFinancial' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::GetPayments200ResponsePaymentsInnerFinancial)
    end
  end
  ...
  describe 'test attribute "kouza_type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["saving", "checking"])
      # validator.allowable_values.each do |value|
      #   expect { instance.kouza_type = value }.not_to raise_error
      # end
    end
  end

  describe 'test attribute "kouza_number"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "kouza_name"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
