...
# Unit tests for ColorMeShop::CancelSaleRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::CancelSaleRequest do
  let(:instance) { ColorMeShop::CancelSaleRequest.new }

  describe 'test an instance of CancelSaleRequest' do
    it 'should create an instance of CancelSaleRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::CancelSaleRequest)
    end
  end

  describe 'test attribute "restock"' do
    it 'should work' do
