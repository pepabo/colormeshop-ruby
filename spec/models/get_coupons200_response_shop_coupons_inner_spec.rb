...
# Unit tests for ColorMeShop::GetCoupons200ResponseShopCouponsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::GetCoupons200ResponseShopCouponsInner do
  let(:instance) { ColorMeShop::GetCoupons200ResponseShopCouponsInner.new }

  describe 'test an instance of GetCoupons200ResponseShopCouponsInner' do
    it 'should create an instance of GetCoupons200ResponseShopCouponsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::GetCoupons200ResponseShopCouponsInner)
    end
  end
  ...
  describe 'test attribute "coupon_type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["amount", "rate", "delivery_charge"])
  ...
  describe 'test attribute "total_usage_limit"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "usage_limit"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["indisposable", "disposable"])
      # validator.allowable_values.each do |value|
      #   expect { instance.usage_limit = value }.not_to raise_error
      # end
    end
  end

  describe 'test attribute "group_limit_type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["none", "including", "excluding"])
      # validator.allowable_values.each do |value|
      #   expect { instance.group_limit_type = value }.not_to raise_error
      # end
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["unavailable", "available"])
      # validator.allowable_values.each do |value|
