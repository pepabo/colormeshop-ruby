...
# Unit tests for ColorMeShop::Payment
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::Payment do
  let(:instance) { ColorMeShop::Payment.new }

  describe 'test an instance of Payment' do
    it 'should create an instance of Payment' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::Payment)
    end
  end
