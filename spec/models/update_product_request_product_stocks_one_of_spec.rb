...
# Unit tests for ColorMeShop::UpdateProductRequestProductStocksOneOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::UpdateProductRequestProductStocksOneOf do
  let(:instance) { ColorMeShop::UpdateProductRequestProductStocksOneOf.new }

  describe 'test an instance of UpdateProductRequestProductStocksOneOf' do
    it 'should create an instance of UpdateProductRequestProductStocksOneOf' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::UpdateProductRequestProductStocksOneOf)
    end
  end
