...
# Unit tests for ColorMeShop::GetSales200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::GetSales200Response do
  let(:instance) { ColorMeShop::GetSales200Response.new }

  describe 'test an instance of GetSales200Response' do
    it 'should create an instance of GetSales200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::GetSales200Response)
    end
  end
