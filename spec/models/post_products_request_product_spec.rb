...
# Unit tests for ColorMeShop::PostProductsRequestProduct
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::PostProductsRequestProduct do
  let(:instance) { ColorMeShop::PostProductsRequestProduct.new }

  describe 'test an instance of PostProductsRequestProduct' do
    it 'should create an instance of PostProductsRequestProduct' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::PostProductsRequestProduct)
    end
  end
