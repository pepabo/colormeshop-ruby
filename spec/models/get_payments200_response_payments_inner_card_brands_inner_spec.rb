...
# Unit tests for ColorMeShop::GetPayments200ResponsePaymentsInnerCardBrandsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::GetPayments200ResponsePaymentsInnerCardBrandsInner do
  let(:instance) { ColorMeShop::GetPayments200ResponsePaymentsInnerCardBrandsInner.new }

  describe 'test an instance of GetPayments200ResponsePaymentsInnerCardBrandsInner' do
    it 'should create an instance of GetPayments200ResponsePaymentsInnerCardBrandsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::GetPayments200ResponsePaymentsInnerCardBrandsInner)
    end
  end
