...
# Unit tests for ColorMeShop::GetStocks200ResponseStocksInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::GetStocks200ResponseStocksInner do
  let(:instance) { ColorMeShop::GetStocks200ResponseStocksInner.new }

  describe 'test an instance of GetStocks200ResponseStocksInner' do
    it 'should create an instance of GetStocks200ResponseStocksInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::GetStocks200ResponseStocksInner)
    end
  end
  ...
  describe 'test attribute "option1_value"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "option2_value"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "variant_model_number"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
