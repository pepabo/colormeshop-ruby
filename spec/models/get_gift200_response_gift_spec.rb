...
# Unit tests for ColorMeShop::GetGift200ResponseGift
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::GetGift200ResponseGift do
  let(:instance) { ColorMeShop::GetGift200ResponseGift.new }

  describe 'test an instance of GetGift200ResponseGift' do
    it 'should create an instance of GetGift200ResponseGift' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::GetGift200ResponseGift)
    end
  end
  ...
  describe 'test attribute "noshi"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "wrapping"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
