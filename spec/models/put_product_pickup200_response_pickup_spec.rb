...
# Unit tests for ColorMeShop::PutProductPickup200ResponsePickup
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::PutProductPickup200ResponsePickup do
  let(:instance) { ColorMeShop::PutProductPickup200ResponsePickup.new }

  describe 'test an instance of PutProductPickup200ResponsePickup' do
    it 'should create an instance of PutProductPickup200ResponsePickup' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::PutProductPickup200ResponsePickup)
    end
  end
