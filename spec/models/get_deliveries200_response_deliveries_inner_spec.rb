...
# Unit tests for ColorMeShop::GetDeliveries200ResponseDeliveriesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::GetDeliveries200ResponseDeliveriesInner do
  let(:instance) { ColorMeShop::GetDeliveries200ResponseDeliveriesInner.new }

  describe 'test an instance of GetDeliveries200ResponseDeliveriesInner' do
    it 'should create an instance of GetDeliveries200ResponseDeliveriesInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::GetDeliveries200ResponseDeliveriesInner)
    end
  end
  ...
  describe 'test attribute "method_type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["other", "yamato", "yamato_pickup", "sagawa", "jp"])
  ...
  describe 'test attribute "charge_free_type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["not_free", "free", "free_to_limit"])
      # validator.allowable_values.each do |value|
      #   expect { instance.charge_free_type = value }.not_to raise_error
      # end
    end
  end

  describe 'test attribute "charge_free_limit"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "charge_type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["fixed", "by_price", "by_area", "by_weight"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "slip_number_use"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "slip_number_url"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "memo2"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "display_state"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["showing", "hidden"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "preferred_date_use"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "preferred_period_use"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
