...
# Unit tests for ColorMeShop::GetProductGroups200ResponseGroupsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::GetProductGroups200ResponseGroupsInner do
  let(:instance) { ColorMeShop::GetProductGroups200ResponseGroupsInner.new }

  describe 'test an instance of GetProductGroups200ResponseGroupsInner' do
    it 'should create an instance of GetProductGroups200ResponseGroupsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::GetProductGroups200ResponseGroupsInner)
    end
  end
