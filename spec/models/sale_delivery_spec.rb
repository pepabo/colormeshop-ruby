...
# Unit tests for ColorMeShop::SaleDelivery
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::SaleDelivery do
  let(:instance) { ColorMeShop::SaleDelivery.new }

  describe 'test an instance of SaleDelivery' do
    it 'should create an instance of SaleDelivery' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::SaleDelivery)
    end
  end
