...
# Unit tests for ColorMeShop::GetPayments200ResponsePaymentsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::GetPayments200ResponsePaymentsInner do
  let(:instance) { ColorMeShop::GetPayments200ResponsePaymentsInner.new }

  describe 'test an instance of GetPayments200ResponsePaymentsInner' do
    it 'should create an instance of GetPayments200ResponsePaymentsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::GetPayments200ResponsePaymentsInner)
    end
  end
  ...
  describe 'test attribute "ip_code"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "order_end_note"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "memo_mobile"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "use_mobile"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "cod"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
