...
# Unit tests for ColorMeShop::UpdateSale200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::UpdateSale200Response do
  let(:instance) { ColorMeShop::UpdateSale200Response.new }

  describe 'test an instance of UpdateSale200Response' do
    it 'should create an instance of UpdateSale200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::UpdateSale200Response)
    end
  end
