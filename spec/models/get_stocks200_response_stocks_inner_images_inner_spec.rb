...
# Unit tests for ColorMeShop::GetStocks200ResponseStocksInnerImagesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::GetStocks200ResponseStocksInnerImagesInner do
  let(:instance) { ColorMeShop::GetStocks200ResponseStocksInnerImagesInner.new }

  describe 'test an instance of GetStocks200ResponseStocksInnerImagesInner' do
    it 'should create an instance of GetStocks200ResponseStocksInnerImagesInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::GetStocks200ResponseStocksInnerImagesInner)
    end
  end
