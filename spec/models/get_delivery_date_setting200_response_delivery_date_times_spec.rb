...
# Unit tests for ColorMeShop::GetDeliveryDateSetting200ResponseDeliveryDateTimes
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ColorMeShop::GetDeliveryDateSetting200ResponseDeliveryDateTimes do
  let(:instance) { ColorMeShop::GetDeliveryDateSetting200ResponseDeliveryDateTimes.new }

  describe 'test an instance of GetDeliveryDateSetting200ResponseDeliveryDateTimes' do
    it 'should create an instance of GetDeliveryDateSetting200ResponseDeliveryDateTimes' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ColorMeShop::GetDeliveryDateSetting200ResponseDeliveryDateTimes)
    end
  end
