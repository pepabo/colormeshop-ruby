...
# Unit tests for ColorMeShop::GroupApi
...
describe 'GroupApi' do
  ...
  describe 'test an instance of GroupApi' do
    it 'should create an instance of GroupApi' do
      expect(@api_instance).to be_instance_of(ColorMeShop::GroupApi)
    end
  end

  # unit tests for get_product_groups
  # 商品グループ一覧を取得
  # 
  # @param [Hash] opts the optional parameters
  # @return [GetProductGroups200Response]
  describe 'get_product_groups test' do
    it 'should work' do
