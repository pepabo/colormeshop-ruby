...
# Unit tests for ColorMeShop::ShopCouponApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ShopCouponApi' do
  before do
  ...
  describe 'test an instance of ShopCouponApi' do
    it 'should create an instance of ShopCouponApi' do
      expect(@api_instance).to be_instance_of(ColorMeShop::ShopCouponApi)
    end
  end
