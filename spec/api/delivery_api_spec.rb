...
# Unit tests for ColorMeShop::DeliveryApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'DeliveryApi' do
  before do
  ...
  describe 'test an instance of DeliveryApi' do
    it 'should create an instance of DeliveryApi' do
      expect(@api_instance).to be_instance_of(ColorMeShop::DeliveryApi)
    end
  end

  # unit tests for get_deliveries
  # 配送方法一覧を取得
  # 
  # @param [Hash] opts the optional parameters
  # @return [GetDeliveries200Response]
  describe 'get_deliveries test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_delivery_date_setting
  # 配送日時設定を取得
  # 
  # @param [Hash] opts the optional parameters
  # @return [GetDeliveryDateSetting200Response]
  describe 'get_delivery_date_setting test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
