...
# Unit tests for ColorMeShop::GiftApi
...
describe 'GiftApi' do
  ...
  describe 'test an instance of GiftApi' do
    it 'should create an instance of GiftApi' do
      expect(@api_instance).to be_instance_of(ColorMeShop::GiftApi)
    end
  end

  # unit tests for get_gift
  # ギフト設定を取得
  # 
  # @param [Hash] opts the optional parameters
  # @return [GetGift200Response]
  describe 'get_gift test' do
    it 'should work' do
